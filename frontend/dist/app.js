...
const candidate_profile_1 = __importDefault(require("./views/candidate-view/candidate-profile"));
const candidate_job_list_1 = __importDefault(require("./views/candidate-view/candidate-job-list"));
const company_profile_1 = __importDefault(require("./views/company-view/company-profile"));
const company_service_1 = __importDefault(require("./services/company-service"));
const company_candidate_list_1 = __importDefault(require("./views/company-view/company-candidate-list"));
const company_graph_1 = __importDefault(require("./views/company-view/company-graph"));
const admin_graph_1 = __importDefault(require("./views/adm-view/admin-graph"));
var candidateService = new candidate_service_1.default();
...
candidateMenu === null || candidateMenu === void 0 ? void 0 : candidateMenu.addEventListener("click", function () {
    var _a, _b, _c;
    (_a = document.querySelector(".menu")) === null || _a === void 0 ? void 0 : _a.remove();
    (0, jquery_1.default)("header").append(`
        <div class=menu>
            <ul>
    ...
    `);
    let view = new candidate_job_list_1.default();
    view.generateTable();
    (_b = document.getElementById("candidate-profile")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", function () {
        let view = new candidate_profile_1.default();
        view.populateForm(candidate);
    });
    (_c = document.getElementById("job-vacancies")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", function () {
        let view = new candidate_job_list_1.default();
        view.generateTable();
    });
});
let companyMenu = document.getElementById("company-menu");
companyMenu === null || companyMenu === void 0 ? void 0 : companyMenu.addEventListener("click", function () {
    var _a, _b, _c, _d;
    (_a = document.querySelector(".menu")) === null || _a === void 0 ? void 0 : _a.remove();
    (0, jquery_1.default)("header").append(`
        <div class=menu>
    ...
    `);
    let view = new company_graph_1.default();
    view.generateGraphs();
    (_b = document.getElementById("company-home")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", function () {
        let view = new company_graph_1.default();
        view.generateGraphs();
    });
    (_c = document.getElementById("company-profile")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", function () {
        let view = new company_profile_1.default();
        view.populateForm(company);
    });
    (_d = document.getElementById("job-vacancy-candidates")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", function () {
        let view = new company_candidate_list_1.default();
        view.generateTable();
    });
});
...
class AcademicExperience {
    constructor(id, educationalInstitution, degreeType, fieldOfStudy, status) {
        this.id = 0;
        this.educationalInstitution = "";
        this.degreeType = "";
        this.fieldOfStudy = "";
        this.status = course_status_1.CourseStatus.Cursando;
        this.id = id;
...
exports.default = AcademicExperience;

},{"../enums/course-status":13}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Candidate {
    constructor(id, name, email, city, state, cep, description, cpf, academicExperiences, workExperiences, languages, skills, certificates) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.city = city;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const contract_type_1 = require("../enums/contract-type");
const location_type_1 = require("../enums/location-type");
const state_1 = require("../enums/state");
class WorkExperience {
    constructor(id, title, companyName, contractType, locationType, city, state, currentlyWork, description) {
        this.id = 0;
        this.title = "";
        this.companyName = "";
        this.contractType = contract_type_1.ContractType.Aprendiz;
        this.locationType = location_type_1.LocationType.Presencial;
        this.city = "";
        this.state = state_1.State.AC;
        this.currentlyWork = false;
        this.description = "";
        this.id = id;
        this.title = title;
...
},{"../enums/contract-type":12,"../enums/location-type":14,"../enums/state":16}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Benefit {
...
Object.defineProperty(exports, "__esModule", { value: true });
class Company {
    constructor(id, name, email, city, state, cep, description, cnpj, jobVacancies, benefits) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.city = city;
...
(function (ContractType) {
    ...
    ContractType["Aprendiz"] = "Aprendiz";
...
(function (CourseStatus) {
    CourseStatus["Cursando"] = "Cursando";
    CourseStatus["Concluido"] = "Conclu\u00EDdo";
    CourseStatus["Trancado"] = "Trancado";
...
(function (LocationType) {
    LocationType["Presencial"] = "Presencial";
    LocationType["Hibrido"] = "H\u00EDbrido";
    LocationType["Remoto"] = "Remoto";
})(LocationType || (exports.LocationType = LocationType = {}));

},{}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Proficiency = void 0;
var Proficiency;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const proficiency_1 = require("../enums/proficiency");
class Language {
    constructor(id, name, proficiency) {
        this.id = 0;
        this.name = "";
        this.proficiency = proficiency_1.Proficiency.Basico;
        this.id = id;
        this.name = name;
...
},{"../enums/proficiency":15}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const proficiency_1 = require("../enums/proficiency");
class Skill {
    constructor(id, title, proficiency) {
        this.id = 0;
        this.title = "";
        this.proficiency = proficiency_1.Proficiency.Basico;
        this.id = id;
...
},{"../enums/proficiency":15}],19:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
const candidatos_json_1 = __importDefault(require("../../../src/main/resources/candidatos.json"));
const candidate_1 = __importDefault(require("../models/candidate/candidate"));
class CandidateService {
    constructor() {
        this.initialCandidates = candidatos_json_1.default;
    }
    generateCandidates() {
        localStorage.setItem("candidates", JSON.stringify(candidatos_json_1.default));
    }
    generateCandidate() {
        ...
        let index = 1;
        let candidate = new candidate_1.default(candidates[index].id, candidates[index].name, candidates[index].email, candidates[index].city, candidates[index].state, candidates[index].cep, candidates[index].description, candidates[index].cpf, candidates[index].academicExperiences, candidates[index].workExperiences, candidates[index].languages, candidates[index].skills, candidates[index].certificates);
        return candidate;
    }
    ...
    createCandidate(candidate) {
        ...
        let newCandidate = JSON.stringify(candidate);
...
Object.defineProperty(exports, "__esModule", { value: true });
const company_1 = __importDefault(require("../models/company/company"));
const empresas_json_1 = __importDefault(require("../../../src/main/resources/empresas.json"));
class CompanyService {
    constructor() {
        this.initialCompanies = empresas_json_1.default;
    }
    generateCompanies() {
        localStorage.setItem("companies", JSON.stringify(empresas_json_1.default));
    }
    generateCompany() {
        ...
        let index = 0;
        let company = new company_1.default(companies[index].id, companies[index].name, companies[index].email, companies[index].city, companies[index].state, companies[index].cep, companies[index].description, companies[index].cnpj, companies[index].jobVacancies, companies[index].benefits);
        return company;
    }
    ...
    createCompany(company) {
        ...
        let newCompany = JSON.stringify(company);
...
Object.defineProperty(exports, "__esModule", { value: true });
const vagas_json_1 = __importDefault(require("../../../src/main/resources/vagas.json"));
class JobVacancyService {
    constructor() {
        this.jobVacancies = vagas_json_1.default;
    }
    populateJobVacancies() {
...
const candidate_service_1 = __importDefault(require("../../services/candidate-service"));
const company_service_1 = __importDefault(require("../../services/company-service"));
const job_vacancy_service_1 = __importDefault(require("../../services/job-vacancy-service"));
class AdminGraph {
    constructor() {
        this.candidateService = new candidate_service_1.default;
        this.companyService = new company_service_1.default;
        this.jobVacancyService = new job_vacancy_service_1.default;
        this.candidatesVsCompaniesVsJobs = new Map();
    }
    populatePersons() {
        let candidates = candidatos_json_1.default;
        let companies = empresas_json_1.default;
        let jobs = vagas_json_1.default;
    ...
    generateGraph() {
        ...
        chart_js_1.Chart.register(chart_js_1.CategoryScale, chart_js_1.LinearScale, chart_js_1.BarController, chart_js_1.BarElement, chart_js_1.Tooltip, chart_js_1.Title);
        (_a = document.querySelector("#container")) === null || _a === void 0 ? void 0 : _a.remove();
        (0, jquery_1.default)("main").append(`
            <div id="container"">
...
class CandidateJobList {
    ...
    populateTable() {
        let jobVacancies = this.jobVacancyService.populateJobVacancies();
        jobVacancies.forEach(vacancy => {
            ...
            `);
            (_a = document.querySelector(`#row-${vacancy.id}`)) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
                (0, jquery_1.default)(`#hidden-row-${vacancy.id}`).toggle();
            });
        });
    }
    populateSkills(jobVacancy) {
        let skills = "";
...
const course_status_1 = require("../../models/enums/course-status");
const contract_type_1 = require("../../models/enums/contract-type");
const location_type_1 = require("../../models/enums/location-type");
const proficiency_1 = require("../../models/enums/proficiency");
const candidate_service_1 = __importDefault(require("../../services/candidate-service"));
const academic_experience_1 = __importDefault(require("../../models/candidate/academic-experience"));
const work_experience_1 = __importDefault(require("../../models/candidate/work-experience"));
...
class CandidateProfile {
    ...
    generateCertificateInformation() {
        (0, jquery_1.default)("#table").append(`
    ...
    generateAcademicButton() {
        var _a;
        const self = this;
        (_a = document.getElementById("add-academic-button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
            (0, jquery_1.default)("#academic-informations").append(`
    ...
    generateWorkButton() {
        var _a;
        const self = this;
        (_a = document.getElementById("add-work-button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
            (0, jquery_1.default)("#work-informations").append(`
    ...
    generateLanguageButton() {
        var _a;
        const self = this;
        (_a = document.getElementById("add-language-button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
            (0, jquery_1.default)("#language-informations").append(`
    ...
    generateSkillButton() {
        ...
        (_a = document.getElementById("add-skill-button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
            (0, jquery_1.default)("#skill-informations").append(`
    ...
    generateCertificateButton() {
        var _a;
        (_a = document.getElementById("add-certificate-button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
            (0, jquery_1.default)("#certification-informations").append(`
    ...
    generateStates() {
        let options;
        Object.entries(state_1.State).forEach(state => {
    ...
    generateStatus() {
        let options;
        Object.values(course_status_1.CourseStatus).forEach(status => {
    ...
    generateContractTypes() {
        let options;
        Object.values(contract_type_1.ContractType).forEach(contractType => {
    ...
    generateLocationTypes() {
        let options;
        Object.values(location_type_1.LocationType).forEach(locationType => {
    ...
    generateProficiencies() {
        let options;
        Object.values(proficiency_1.Proficiency).forEach(proficiency => {
    ...
    populateBasicInformation(candidate) {
        (0, jquery_1.default)("#table").append(`
            <div id="basic-information" class="information">
                <div class="form-field form-text">
                    <label>Nome:</label>
    ...
    populateStatus(selectedStatus) {
        let options;
        Object.entries(course_status_1.CourseStatus).forEach(status => {
    ...
    populateContractType(selectedType) {
        let options;
        Object.entries(contract_type_1.ContractType).forEach(contractType => {
    ...
    populateLocationType(selectedType) {
        let options;
        Object.entries(location_type_1.LocationType).forEach(locationType => {
    ...
    populateProficiencies(selectedProficiency) {
        let options;
        Object.entries(proficiency_1.Proficiency).forEach(proficiency => {
...
class CompanyGraph {
    constructor() {
        this.candidateService = new candidate_service_1.default;
        this.candidatesPerSkill = new Map();
    }
    populateSkills() {
        let candidates = candidatos_json_1.default;
        candidates.forEach(candidate => {
            candidate.skills.forEach(skill => {
                if (this.candidatesPerSkill.has(skill.title)) {
                    let value = this.candidatesPerSkill.get(skill.title) + 1;
...
class CompanyProfile {
    ...
    generateBenefitButton() {
        var _a;
        (_a = document.getElementById("add-benefit-button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
            (0, jquery_1.default)("#benefit-informations").append(`
    ...
    populateBasicInformation(company) {
        (0, jquery_1.default)("#table").append(`
            <div id="basic-information" class="information">
                <div class="form-field form-text">
                    <label>Nome:</label>
